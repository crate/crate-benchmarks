...
public class GroupByArbitraryBenchmark extends BenchmarkBase {
    ...
    public static final String GROUP_BY_STMT = String.format("select continent, \"countryName\" from %s group by 1, 2 ", TABLE_NAME);
    public static final String ARBITRARY_STMT = String.format("select continent, arbitrary(\"countryName\") from %s group by 1", TABLE_NAME);
